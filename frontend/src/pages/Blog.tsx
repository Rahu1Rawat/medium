  ...
  return (
    <div>
      ...
      <div className="flex justify-center ">
        <div className="w-680 h-screen mt-10">
          <div className="w-full">
            <span className="text-5xl font-extrabold">{blog.title}
            </span>
          </div>
          <div>
            <div className="mt-5">
              <span className="text-xl text-gray-500">
                A short description about the blog that has been posted A short
                description about the blog that has been posted most important.
              </span>
            </div>
            ...
            <div className="flex justify-between mt-6 text-gray-500 border-y h-12 items-center">
              <div className="flex gap-5">
                ...
                <div className="flex">
                  <svg
                    ...
                    height="24"
                    viewBox="0 0 24 24"
                    className="sf text-gray-500 fill-current"
                  >
              ...
              <div className="flex gap-5">
                <div>
                  <svg
                    ...
                    height="24"
                    viewBox="0 0 24 24"
                    className="ib text-gray-500 fill-current"
                  >
            ...
            <div className="mt-8">
              <p className="font-serif">{blog.content}
                </p>
            </div>
          </div>
        </div>
