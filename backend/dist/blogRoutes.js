...
import { blogInputSchema, updateBlogInputSchema, } from "@rahu1_rawat/medium-commons";
...
blogRoutes.post("", async (c) => {
    ...
    try {
        ...
        return c.json({ message: "Post created successfully", postId: post.id }, 201);
    }
    catch (error) {
...
blogRoutes.put("/:id", async (c) => {
    ...
    try {
        ...
        try {
            ...
            return c.json({ message: "Post Updated Successfully", post: updatePost }, 200);
        }
        catch (updateError) {
